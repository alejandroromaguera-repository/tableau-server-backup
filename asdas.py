SELECT 
    ...
    (CASE
        ...
        THEN    
            (
                CASE 
                    WHEN V.GROUPED_CLIENT_NAME_CLI LIKE 'LIVERPOOL' and pick.ORDERENTRY IS NULL
                    THEN V.CREATEDATE_PED
                    WHEN V.GROUPED_CLIENT_NAME_CLI LIKE 'LIVERPOOL' and pick.ORDERENTRY IS NOT NULL
                    THEN SYSDATE
