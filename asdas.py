SELECT 
    ...
    (CASE
        ...
        THEN    
            (
                CASE 
                    WHEN V.CARDNAME_CLI LIKE 'LIVERPOOL'
...
PED.PROJECT AS PROJECT_PED,
PED.PRJNAME  AS PRJNAME_PED,
...
ENTR.CANTIDADRECIBIDA  AS CANTIDADRECIBIDA_ENTR,
...
FACT.LINETOTAL  AS LINETOTAL_FACT,
